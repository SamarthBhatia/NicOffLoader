...
Whenever a DSL config enables admission control, the CLI/TUI summaries now surface the most recent admission limit and how many tasks were blocked, making it obvious when concurrency clamps are shaping the queue.

...
waiting-queue depth plus cumulative vs. recent waiting-reorder ratios (x-axis labels now note the rolling preset/schedule tags when present). Run `python3 experiments/policy_baseline/export_normalized.py`

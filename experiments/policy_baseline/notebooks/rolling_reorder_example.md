...
4. Optionally renders a paired bar chart (using matplotlib) to visualize total vs. recent reorder ratios, mirroring the in-tree plot but directly within pandas so it can be adapted into notebooks or BI tools.

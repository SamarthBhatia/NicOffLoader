...
- **Next:** Prototype a property-based scheduler fuzz harness that varies stochastic seeds and burst arrivals to shake out latent admission/reorder corner cases.
